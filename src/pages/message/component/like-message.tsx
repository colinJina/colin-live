...
export default function LikeMessage() {
    const { list, isLoading, isFetchingNextPage, hasMore, fetchNextPage } = useMessageList(2);
    ...
    return (
        <div className="flex h-full flex-col">
            <h2 className="mb-6 text-lg font-bold text-[#5a3040] shrink-0">收到的赞</h2>
                        ...
                        >
                            ...
                            <div className="flex-1">
                                <div className="text-[14px] text-[#5a3040]">
                                    ...
                                    <span className="mx-2 text-[#9f4b67]">点赞了你的视频</span>
                                </div>
                                <div className="mt-1 text-[12px] text-[#9499a0]">
                                    {msg.createTime}
                                </div>
                            </div>
                            <div className="w-24 shrink-0 cursor-pointer overflow-hidden rounded-xl border border-white/50 bg-[#f7f8fa]">
                                {msg.videoCover ? (
                                    <img
