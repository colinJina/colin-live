...
export function VideoCard({ video, className }: VideoCardProps) {
    return (
        <div
            className={cn(
                'group overflow-hidden relative rounded-2xl bg-white shadow-[0_10px_30px_rgba(24,25,28,0.08)] ring-1 ring-black/5 transition-transform duration-200 hover:-translate-y-0.5',
                className,
            )}
        >
            <img
                ...
                alt=""
                className="aspect-video w-full bg-[#f7f8fa] rounded-2xl object-cover"
                loading="lazy"
            />
            <div className="p-3">
