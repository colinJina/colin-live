...
export function VideoDanmuList({
    ...
    return (
        <section className="flex flex-1 flex-col overflow-hidden rounded-[28px] border border-white/80 bg-[linear-gradient(135deg,rgba(255,249,252,0.98)_0%,rgba(255,239,246,0.98)_100%)] shadow-[0_18px_40px_rgba(251,114,153,0.12)] ring-1 ring-[#ffd8e4]/70">
            <div className="flex items-center justify-between border-b border-white/70 bg-white/56 px-4 py-3 backdrop-blur-md">
                ...
                <span className="rounded-full border border-[#ffe1ea] bg-white/70 px-3 py-1 text-xs text-[#b07b90]">
                    {'\u5c55\u5f00'}
                </span>
            </div>

            <div className="max-h-[300px] flex-1 overflow-y-auto bg-white/46 px-2 py-2 text-sm">
                {isLoading ? (
                    ...
                    danmuList.map((item) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <p className="min-w-0 flex-1 truncate text-[#6f3f55]" title={text}>
                                    {text || '---'}
                                </p>
